...
actor's movies, we can make these analyses easier to produce by creating an interactive application that wraps our new function. The `shiny` package makes creating this type of application easy. This shiny code to creates our movie analysis application:
